...
# ---------Cargo los archivos----------
direccion_ejecutable = Path('Resultados_rhodamina.py').parent
direccion_arhivos = direccion_ejecutable / 'Mediciones_dia2' / 'Rhodamina'
direccion_arhivos_guardado = direccion_ejecutable / 'Mediciones_dia2' / 'Resultados_rhodamina'

concentraciones = os.listdir(direccion_arhivos)
